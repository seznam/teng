 ...
 */
/* $Id: tengmd5.cc,v 1.1 2004-07-28 11:36:55 solamyl Exp $ */
/*
...
/*
 * TENG:
 * This file was modified by teng authors. It is not the original version!
 *
 * AUTHORS
...
int Teng::tengMD5Hexdigest(const string &data, string &hexdigest) {
